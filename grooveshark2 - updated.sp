...
public Action Command_GrooveShark(int client, int args)
{
	...
	HTTPRequest hHTTPRequest = new HTTPRequest("https://inv.perditum.com/api/v1/search");
...
void OnHTTPResponse(HTTPResponse response, any value)
{
	...
	Format(gs_SongLink, sizeof(gs_SongLink), "https://music.youtube.com./watch?v=%s", url);
